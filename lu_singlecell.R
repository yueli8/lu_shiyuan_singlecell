...
VlnPlot(pbmc, features = c("LZTFL1"))
VlnPlot(pbmc, features = c("MOSPD3"))
VlnPlot(pbmc, features = c("CCNB1"))
VlnPlot(pbmc, features = c("PTTG1"))
VlnPlot(pbmc, features = c("MACF1"))
VlnPlot(pbmc, features = c("NEAT1"))
VlnPlot(pbmc, features = c("IL13"))
VlnPlot(pbmc, features = c("IL5"))
